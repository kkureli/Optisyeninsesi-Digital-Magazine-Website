...
import DergilerMapper from "../../homepage/dergiler/DergilerMapper";
    ...
    <div className={classes.root}>
      <AppBar position="static" color="default">
        ...
        >
          ...
          <Tab label="2014" {...a11yProps(6)} />
          <Tab label="2013" {...a11yProps(7)} />
          <Tab label="2012" {...a11yProps(8)} />
        </Tabs>
      </AppBar>
      ...
      <TabPanel value={value} index={1}>
        <Row>
          <DergilerMapper dergiler={dergiler2019}></DergilerMapper>
        </Row>
      </TabPanel>
